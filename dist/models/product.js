...
var ProductDB = /** @class */ (function () {
    ...
    ProductDB.prototype.index = function () {
    ...
    ProductDB.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProductDB.prototype.create = function (p) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProductDB.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not delete book " + id + ". Error: " + err_4);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductDB.prototype.clearTableProducts = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
