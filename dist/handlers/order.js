...
var addProduct = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var prodInOrder, addedProduct, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                prodInOrder = {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.addProduct(prodInOrder)];
            case 2:
...
var orderByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, user_id, orders, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
            ...
            case 1:
                ...
                return [4 /*yield*/, store.orderByUser(user_id)];
            case 2:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 4];
